...
const __bootActuator = (() => {
  ...
  layoutParts(OPEN); render(spin); paint(spin);   // pre-render: never blank on arrival
  start();
});
(() => {
  ...
  if ("requestIdleCallback" in window) requestIdleCallback(idle, { timeout: 2600 });
